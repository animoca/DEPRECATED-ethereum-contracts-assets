...
import {IERC165, ERC20Burnable} from "./ERC20Burnable.sol";
 ...
 */
contract ChildERC20Burnable is ERC20Burnable, ChildERC20Base {
    constructor(
        string memory name_,
        string memory symbol_,
        uint8 decimals_,
        address childChainManager
    ) ERC20Burnable(name_, symbol_, decimals_) ChildERC20Base(childChainManager) {}
