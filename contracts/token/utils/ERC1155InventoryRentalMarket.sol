...
contract ERC1155InventoryRentalMarket is NFTRentalMarket, ERC1155TokenReceiver {
    ...
    ) NFTRentalMarket(forwarderRegistry, universalForwarder, nftContract, periodInSeconds, operator, operatorShare) {}
    ...
    function onERC1155Received(
        ...
        require(msg.sender == address(NFT_CONTRACT), "NFTRental: wrong NFT contract");
        require(!IDelegatableERC1155Inventory(NFT_CONTRACT).isFungible(id), "NFTRental: only NFTs");
    ...
    function withdrawToken(uint256 tokenId) external {
        ...
        IDelegatableERC1155Inventory(NFT_CONTRACT).safeTransferFrom(address(this), owner, tokenId, 1, "");
    }
    ...
    function batchWithdrawToken(uint256[] calldata tokenIds) external {
        ...
        IDelegatableERC1155Inventory(NFT_CONTRACT).safeBatchTransferFrom(address(this), owner, tokenIds, values, "");
    }
}
