...
function shouldBehaveLikeERC1155InventoryCreator(implementation) {
  const {contractName, nfMaskLength, interfaces, revertMessages, methods, deploy, mint} = implementation;
