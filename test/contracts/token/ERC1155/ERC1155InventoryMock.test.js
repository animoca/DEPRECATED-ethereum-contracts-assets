...
const implementation = {
  ...
  interfaces: {ERC1155: true, ERC1155MetadataURI: true, ERC1155Inventory: true, ERC1155InventoryTotalSupply: true, ERC1155InventoryCreator: true},
  ...
  deploy: async function (deployer, collectionMaskLength = 32) {
    ...
    return artifacts.require('ERC1155InventoryMock').new(registry.address, ZeroAddress, collectionMaskLength, {from: deployer});
  },
