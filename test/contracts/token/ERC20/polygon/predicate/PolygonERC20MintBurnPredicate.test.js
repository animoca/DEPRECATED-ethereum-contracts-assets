...
describe('PolygonERC20MintBurnPredicate', function () {
  const fixtureLoader = createFixtureLoader(accounts, web3.eth.currentProvider);

  const fixture = async function () {
    this.predicate = await artifacts.require('PolygonERC20MintBurnPredicate').new(rootChainManager, {from: deployer});
